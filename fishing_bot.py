...
class GPOFishingBot:
    ...
    def should_click_v4(self, gray_y, white_y):
        ...
        if distance > 150:
            ...
            return True, "fast", 450   # Loin : monter contrôlé
        elif distance > 80:
            return True, "fast", 255 # Loin : monter contrôlé
        elif distance > 50:
            return True, "hover", 125  # Moyennement loin : ralentir progressivement
        elif distance > 30:
            return True, "hover", 100  # Moyennement loin : ralentir progressivement
        elif distance > 1:
